...
const Productos = () => {
  ...
  const manejoCambioArchivo = (e) => {
    ...
    if (archivo && archivo.type.startsWith("image/")) {
      ...
      alert("Selecciona una imágen válida (JPG, PNG, etc...)");
    }
  };
  ...
  // Método UseEffect para estado inicial y manejo cuadro búsqueda:
  useEffect(() => {
  ...
  // Método para subir la imágen y crear el producto:
  const agregarProducto = async () => {
    ...
    const { error: uploadError } = await supabase.storage
      ...
      .upload(nombreArchivo, setNuevoProducto.archivo);
