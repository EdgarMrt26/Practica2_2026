...
const TarjetaCatalogo = ({ producto, categoriaNombre }) => {
  ...
  return (
    <>
      ...
      >
        <div className="retio ratio-1x1 bg-light" style={{ overflow: "hidden" }}>
          {producto.url_imagen ? (
            <img
      ...
      {/* Modal para mostrar los detalles completos de cada uno de los productos del catálogo */}
          ...
          <div className="row g-4">
            <div className="col-md-5">
              {producto.url_imagen ? (
                ...
                <div className="bg-secondary-subtle rounded d-flex align-items-center justity-content-center" style={{ height: "400px" }}>
                  <i className="bi bi-image text-muted fs-1"></i>
                </div>
              )}
            </div>
